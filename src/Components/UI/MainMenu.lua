...
function MainMenu:SetUpOpening()
    ...
    LeftMenuToggleHintBackArrow.Active = false
    LeftMenuToggleHintBackArrow.Interactable = false
    ...
    LeftMenuToggleHintBackText.Active = false
    LeftMenuToggleHintBackText.Interactable = false
    ...
    RightMenuToggleHintBackArrow.Active = false
    RightMenuToggleHintBackArrow.Interactable = false
    ...
    RightMenuToggleHintBackText.Active = false
    RightMenuToggleHintBackText.Interactable = false
