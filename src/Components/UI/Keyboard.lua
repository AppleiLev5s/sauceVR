            ...
            elseif key.Name == "Enter" then
                if Preview.Text ~= "" then
                    ...
                    if game:GetService("TextChatService").ChatVersion == Enum.ChatVersion.TextChatService then
                        game:GetService("TextChatService").TextChannels.RBXGeneral:SendAsync(Preview.Text)
                    else
                        ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer(Preview.Text, "All")
                    end
                    Preview.Text = ""
                end
